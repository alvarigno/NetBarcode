...
namespace AppNetBarcode
{
    ...
    public class Barcode
    {
        ...
        private readonly Font _labelFont = new Font("Times New Roman", 90, FontStyle.Regular, GraphicsUnit.Pixel);
        ...
        private void InitializeType()
        {
            ...
            IBarcode barcode = new EAN13(_data);
